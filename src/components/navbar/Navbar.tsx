...
export default function Navbar() {
  ...
  return (
    <div>
    <nav className="bg-white dark:bg-blackground-900 flex items-center fixed w-full z-20 top-0 left-0">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div
          ...
          id="navbar-sticky"
        >
          <ul className="bg-black opacity-100 md:bg-opacity-100 md:bg-black md:bg-slate-900 flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
